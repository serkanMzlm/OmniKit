...
LCD::LCD(int bus_number, uint8_t address) : _addr(address),
...
void LCD::sleep_ms(uint16_t ms) { usleep(static_cast<useconds_t>(ms) * 1000U); }
void LCD::sleep_us(uint16_t us) { usleep(us); }
